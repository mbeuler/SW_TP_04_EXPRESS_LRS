...
static const uint8_t CRC8_DVB_S2_TABLE[256] = {
    ...
    0xD6,0x03,0xA9,0x7C,0x28,0xFD,0x57,0x82,0xB6,0x63,0xC9,0x1C,0x48,0x9D,0x37,0xE2,
    0xCD,0x18,0xB2,0x67,0x33,0xE6,0x4C,0x99,0x64,0xB1,0x1B,0xCE,0x9A,0x4F,0xE5,0x30
};
